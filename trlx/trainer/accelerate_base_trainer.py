...
class AccelerateRLTrainer(BaseRLTrainer):
    ...
    def __init__(self, config, **kwargs):  # noqa: C901
        ...
        self.mb_count = 0
        self.accelerator = Accelerator(log_with=config.train.tracker, project_dir=config.train.logging_dir, deepspeed_plugin=DeepSpeedPlugin(hf_ds_config=hf_ds_config))
    ...
    def save(self, directory: Optional[str] = None, **kwargs):
        ...
        self.accelerator.unwrap_model(self.model).config.save_pretrained(dst_dir)
